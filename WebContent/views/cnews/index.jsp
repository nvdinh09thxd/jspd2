  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
		...
		<div class="item">
        	<h2><h2><a href="<%=request.getContextPath() %>/views/cnews/detail.jsp" title="">Bootstrap 4 alpha đã ra mắt</a></h2>
	        <img src="images/img_3.jpg" alt="" width="585" height="156" />
	        <div class="clr"></div>
	        <p>Bootstrap 4 là một sự đảm bảo chắc chắn tới từng dòng code. Đội ngũ xây dựng đã rất</p>
		</div>
		
		<div class="item">
        	<h2><h2><a href="<%=request.getContextPath() %>/views/cnews/detail.jsp" title="">Material Design là gì?</a></h2>
	        <img src="images/img_1.jpg" alt="" width="585" height="156" />
	        <div class="clr"></div>
	        <p>Phong cách thiết kế Material Design nhắm đến những đường nét đơn giản, sử dụng nhiều</p>
		</div>
