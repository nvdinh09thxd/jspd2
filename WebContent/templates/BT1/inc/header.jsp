...
<html>
   <head>
      ...
      <link href="<%=request.getContextPath() %>/templates/BT1/css/style.css" rel="stylesheet" type="text/css">
   </head>
   <body>
      <div class="main">
      <div class="page">
      <div class="header">
         <div class="header-img">
            <img src="<%=request.getContextPath() %>/templates/BT1/images/header.jpg" alt="" width="800">
         </div>
         <div class="topmenu">
            <ul>
